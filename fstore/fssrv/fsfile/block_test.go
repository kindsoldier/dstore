...
func Test_Block_SmallLwriteToBeginRead(t *testing.T) {
    var err error
    var fileId  int64 = 1
    var batchId int64 = 2
    var blockId int64 = 3
    ...
    written, err := block.Lwrite(reader, dataSize)
...
func Test_Block_SmallWriteToBeginRead(t *testing.T) {
    var err error
    var fileId  int64 = 1
    var batchId int64 = 2
    var blockId int64 = 3
...
func Test_Block_OverWriteCloseRead(t *testing.T) {
    var err error
    var fileId  int64 = 11
